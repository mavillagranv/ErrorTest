...
var at = ((s) => (s.VERBOSE = "VERBOSE", s.INFO = "INFO", s.WARN = "WARN", s.ERROR = "ERROR", s))(at || {});
var v = {
  BACKSPACE: 8,
  TAB: 9,
  ENTER: 13,
...
function zt(s, e = () => {
  ...
  return __async(this, null, function* () {
    function o(i, n, r) {
      return __async(this, null, function* () {
        try {
          yield i.function(i.data), yield n(Qe(i.data) ? {} : i.data);
        } catch {
          r(Qe(i.data) ? {} : i.data);
        }
      });
...
function Ie(s, e, t = void 0) {
  ...
  return function() {
    const d = Date.now();
    !a && t.leading === false && (a = d);
    const u = e - (d - a);
    return o = this, i = arguments, u <= 0 || u > e ? (r && (clearTimeout(r), r = null), a = d, n = s.apply(o, i), r || (o = i = null)) : !r && t.trailing !== false && (r = setTimeout(l, u)), n;
  };
}
function $t() {
  const s = {
...
var c = class _c {
  ...
  static findAllInputs(e) {
    return ct(e.querySelectorAll(_c.allInputsSelector)).reduce((t, o) => _c.isNativeInput(o) || _c.containsOnlyInlineElements(o) ? [...t, o] : [...t, ..._c.getDeepestBlockElements(o)], []);
  }
  /**
  ...
  static isNodeEmpty(e, t) {
    let o;
    return this.isSingleTag(e) && !this.isLineBreakTag(e) ? false : (this.isElement(e) && this.isNativeInput(e) ? o = e.value : o = e.textContent.replace("​", ""), t && (o = o.replace(new RegExp(t, "g"), "")), o.trim().length === 0);
  }
  /**
  ...
  static containsOnlyInlineElements(e) {
    ...
    const o = (i) => !_c.blockElements.includes(i.tagName.toLowerCase()) && Array.from(i.children).every(o);
  ...
  static getDeepestBlockElements(e) {
    return _c.containsOnlyInlineElements(e) ? [e] : Array.from(e.children).reduce((t, o) => [...t, ..._c.getDeepestBlockElements(o)], []);
  }
  /**
...
var b = class _b {
  ...
  static isSelectionAtEditor(e) {
    ...
    let o = null;
    return t && t instanceof Element && (o = t.closest(`.${_b.CSS.editorZone}`)), o ? o.nodeType === Node.ELEMENT_NODE : false;
  }
  /**
...
var R = class _R extends Ee {
  ...
  constructor({
    ...
    super(), this.cachedInputs = [], this.toolRenderedElement = null, this.tunesInstances = /* @__PURE__ */ new Map(), this.defaultTunesInstances = /* @__PURE__ */ new Map(), this.unavailableTunesData = {}, this.inputIndex = 0, this.editorEventBus = null, this.handleFocus = () => {
      ...
      let h;
      d || u ? h = true : h = !(l.length > 0 && l.every((x) => {
   ...
   */
  compose() {
    const e = c.make("div", _R.CSS.wrapper), t = c.make("div", _R.CSS.content), o = this.toolInstance.render();
...
`);
      ...
      function H(k, g) {
        ...
        if (g.singleton) {
          var O = h++;
          w = u || (u = S(g)), E = ce.bind(null, w, O, false), I = ce.bind(null, w, O, true);
        } else
...
(function(s, e) {
  (function(t, o) {
    ...
    function u(h, f, x) {
      ...
      return f === true ? false : typeof f[p] == "function" ? !f[p](h.value, x) : typeof f[p] > "u" || f[p] === false ? true : typeof f[p] == "string" ? f[p] !== h.value : false;
    }
    return t;
  });
})(fo);
...
var _ = class __ {
  ...
  enableConfirmationMode(e) {
    ...
    this.nodes.root.innerHTML = o.innerHTML, this.nodes.root.classList.add(__.CSS.confirmationState), this.confirmationState = e, this.enableSpecialHoverAndFocusBehavior();
  }
  /**
...
var N = class extends Ee {
  ...
  constructor(s) {
    ...
    }, this.items = s.items.map((e) => new _(e)), s.scopeElement !== void 0 && (this.scopeElement = s.scopeElement), s.messages && (this.messages = __spreadValues(__spreadValues({}, this.messages), s.messages)), s.customContentFlippableItems && (this.customContentFlippableItems = s.customContentFlippableItems), this.make(), s.customContent && this.addCustomContent(s.customContent), s.searchable && this.addSearch(), this.initializeFlipper();
  }
  /**
   * Popover CSS classes
   */
...
var $ = class _$ extends y {
  ...
  addTool(e, t) {
    var r;
    const o = c.make("div", [_$.CSS.conversionTool]), i = c.make("div", [_$.CSS.conversionToolIcon]);
    ...
    if (n) {
      const a = c.make("span", _$.CSS.conversionToolSecondaryLabel, {
        innerText: ye(n)
      });
      c.append(o, a);
    }
  ...
  filterTools() {
    return __async(this, null, function* () {
      ...
      this.tools.forEach((i) => {
        ...
        i.button.hidden = n, i.button.classList.toggle(_$.CSS.conversionToolHidden, n);
      });
    });
  }
  /**
...
var ke = ((s) => (s.Opened = "toolbox-opened", s.Closed = "toolbox-closed", s.BlockAdded = "toolbox-block-added", s))(ke || {});
...
function Go(s, e) {
  return __async(this, null, function* () {
    ...
    return t && (yield t.getLayoutMap()).get(s) || e;
  });
}
var Jo = class extends y {
  ...
  make() {
    return __async(this, null, function* () {
      ...
      const t = c.make("div"), o = c.text(z.ui(K.ui.blockTunes.toggler, "Click to tune")), i = yield Go("Slash", "/");
...
var ve = ((s) => (s.Shortcut = "shortcut", s.Toolbox = "toolbox", s.EnabledInlineTools = "inlineToolbar", s.EnabledBlockTunes = "tunes", s.Config = "config", s))(ve || {});
var Et = ((s) => (s.Shortcut = "shortcut", s.SanitizeConfig = "sanitize", s))(Et || {});
var se = ((s) => (s.IsEnabledLineBreaks = "enableLineBreaks", s.Toolbox = "toolbox", s.ConversionConfig = "conversionConfig", s.IsReadOnlySupported = "isReadOnlySupported", s.PasteConfig = "pasteConfig", s))(se || {});
var We = ((s) => (s.IsInline = "isInline", s.Title = "title", s))(We || {});
var Bt = ((s) => (s.IsTune = "isTune", s))(Bt || {});
var Ye = class {
  /**
   * @class
...
var Qo = class extends y {
  ...
  tryToShow(e = false, t = true) {
    return __async(this, null, function* () {
      e && this.close(), this.allowedToShow() && (yield this.addToolsFiltered(t), this.move(), this.open(t), this.Editor.Toolbar.close());
    });
  }
  /**
  ...
  addToolsFiltered(e = true) {
    return __async(this, null, function* () {
      ...
      this.nodes.buttons.innerHTML = "", this.nodes.actions.innerHTML = "", this.toolsInstances = /* @__PURE__ */ new Map(), Array.from(o.tool.inlineTools.values()).forEach((i) => {
        this.addTool(i);
      }), e && this.Editor.ConversionToolbar.hasTools() ? yield this.setConversionTogglerContent() : this.nodes.conversionToggler.hidden = true, this.recalculateWidth();
    });
  }
  /**
...
var ei = class extends y {
  ...
  tabPressed(e) {
    ...
    if (o.opened || t.opened)
      return;
    (e.shiftKey ? i.navigatePrevious(true) : i.navigateNext(true)) && e.preventDefault();
  }
  /**
...
var ii = class extends y {
  ...
  mergeBlocks(e, t) {
    return __async(this, null, function* () {
      ...
      W(o) || (yield e.mergeWith(o)), this.removeBlock(t), this.currentBlockIndex = this._blocks.indexOf(e);
    });
  }
  /**
   * Remove passed Block
  ...
  convert(e, t, o) {
    return __async(this, null, function* () {
      ...
      const r = yield e.exportDataAsString(), a = V(
        r,
        n.sanitizeConfig
      );
...
var ni = class extends y {
  ...
  clearSelection(e, t = false) {
    ...
    if (this.anyBlockSelected && r && a && !b.isSelectionExists) {
      ...
      o.insertDefaultBlockAtIndex(l, true), i.setToBlock(o.currentBlock), xe(() => {
        const d = e.key;
...
var we = class _we extends y {
  ...
  get isAtEnd() {
    ...
    const t = b.get();
    let o = t.focusNode;
    const i = c.getDeepestNode(e.currentInput, true);
  ...
  navigateNext(e = false) {
    ...
    return l ? (this.setToBlock(a, this.positions.START), true) : false;
  }
  /**
  ...
  navigatePrevious(e = false) {
    ...
    return i && n ? (this.setToInput(i, this.positions.END), true) : o !== null && n ? (this.setToBlock(o, this.positions.END), true) : false;
  }
  /**
    ...
    super(...arguments), this.onMouseUp = () => {
      ...
      if (!(!i || !n) && n !== i) {
        if (i === this.firstSelectedBlock) {
          b.get().removeAllRanges(), i.selected = true, n.selected = true, o.clearCache();
          return;
        }
...
var Ct = class extends y {
  ...
  processDataTransfer(s, e = false) {
    return __async(this, null, function* () {
      ...
      !u.trim() || u.trim() === r || !c.isHTMLString(u) ? yield this.processText(r) : yield this.processText(u, true);
    });
  }
  /**
  ...
  getFilesConfig(s) {
    ...
    !t && !o || (t && !Array.isArray(t) && (T(`«extensions» property of the onDrop config for «${s.name}» Tool should be an array`), t = []), o && !Array.isArray(o) && (T(`«mimeTypes» property of the onDrop config for «${s.name}» Tool should be an array`), o = []), o && (o = o.filter((i) => jt(i) ? true : (T(`MIME type value «${i}» for the «${s.name}» Tool is not a valid MIME type`, "warn"), false))), this.toolsFiles[s.name] = {
      extensions: t || [],
      mimeTypes: o || []
    });
  }
...
var fe = class _fe extends y {
   ...
   */
  genHTML() {
    const { UI: e } = this.Editor, t = e.nodes.holder.querySelector("." + e.CSS.editorWrapper), o = c.make("div", _fe.CSS.overlay, {}), i = c.make("div", _fe.CSS.overlayContainer, {}), n = c.make("div", _fe.CSS.rect, {});
  ...
  changingRectangle(e) {
    ...
    this.rectCrossesBlocks = !(n || r), this.isRectSelectionActivated || (this.rectCrossesBlocks = false, this.isRectSelectionActivated = true, this.shrinkRectangleToPoint(), this.overlayRectangle.style.display = "block"), this.updateRectangleSize(), this.Editor.Toolbar.close(), i !== void 0 && (this.trySelectNextBlock(i), this.inverseSelection(), b.get().removeAllRanges());
  }
  /**
      ...
      return new Promise((t) => {
        ...
        if (e.length === 0)
          ...
          const n = e.map(({ type: r, data: a, tunes: l, id: d }) => {
            o.available.has(r) === false && (Y(`Tool «${r}» is not found. Check 'tools' property at the Editor.js config.`, "warn"), a = this.composeStubDataForTool(r, a, d), r = o.stubTool);
            let u;
            try {
              u = i.composeBlock({
                id: d,
  ...
  save() {
    return __async(this, null, function* () {
      ...
      try {
        ...
        const n = yield Promise.all(i), r = yield bt(n, (a) => t.blockTools.get(a).sanitizeConfig);
...
var wi = class extends y {
  ...
  enableModuleBindings() {
    ...
    }, false), this.readOnlyMutableListeners.on(this.nodes.redactor, "mousedown", (o) => {
    ...
    }, true), this.readOnlyMutableListeners.on(document, "mousedown", (o) => {
  ...
  backspacePressed(e) {
    ...
    if (o.anyBlockSelected && !b.isSelectionExists) {
      const n = t.removeSelectedBlocks(), r = t.insertDefaultBlockAtIndex(n, true);
...
var Ei = class {
  ...
  set configuration(e) {
    var o, i;
    D(e) ? this.config = __spreadValues({}, e) : this.config = {
      holder: e
    ...
    }), this.config.inlineToolbar = this.config.inlineToolbar !== void 0 ? this.config.inlineToolbar : true, (W(this.config.data) || !this.config.data.blocks || this.config.data.blocks.length === 0) && (this.config.data = { blocks: [t] }), this.config.readOnly = this.config.readOnly || false, (o = this.config.i18n) != null && o.messages && z.setDictionary(this.config.i18n.messages), this.config.i18n.direction = ((i = this.config.i18n) == null ? void 0 : i.direction) || "ltr";
  }
  /**
...
@editorjs/editorjs/dist/editorjs.mjs:
   ...
   *)
*/
//# sourceMappingURL=@editorjs_editorjs.js.map
